  ...
  if (msg !== undefined && msg !== null) {
    ...
    if (messageTextBody === "Model") {
      ...
      if (listReplyID === "dalle") {
        ...
        await sendMessage_(
          from,
          "You can now send messages to generate images",
          "text"
        );
        ...
        await sendMessage_(
          from,
          "You can now send messages to ChatGPT",
          "text"
        );
        ...
        await sendMessage_(
          from,
          "آپ اب اس کمپیوٹر پروگرام سے اردو زبان میں بات کرسکتے ہیں۔",
          "text"
        );
        ...
        await sendMessage_(
          from,
          "You can now talk to this bot in English",
          "text"
        );
      }
      ...
      if (aiModel.getModel() === "chatgpt") {
        ...
        const isEnglish = await creatChatcompletion_(
          textBody,
          "languageDetectPrompt"
        );
        if (isEnglish.toLowerCase().includes("yes")) {
          ...
          const translatedPromptInEnglish = await creatChatcompletion_(
            textBody,
